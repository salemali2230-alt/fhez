...
export const chapters: Chapter[] = [
  {
    ...
    explanation: [
      ...
      { type: 'paragraph', content: 'الموصلات هي مواد تسمح للشحنات الكهربائية بالحركة خلالها بسهولة، مثل الفلزات (النحاس، الذهب، الألمنيوم). أما العوازل فهي مواد تقاوم حركة الشحنات خلالها، مثل الزجاج، البلاستيك، والخشب الجاف.' },
    ...
    games: {
      quiz: [
        ...
        },
        {
          ...
          options: ['النحاس', 'الزجاج', 'الألمنيوم', 'الماء المالح'],
          correctAnswerIndex: 1
        },
        {
